...
*/
-- CreateEnum
CREATE TYPE "OrderStatusEnum" AS ENUM ('Processing', 'Shipped', 'Delivered', 'Cancelled');

-- CreateEnum
CREATE TYPE "CatogoryEnum" AS ENUM ('Clothes', 'Murti', 'Tilak', 'Accessories');
...
CREATE TABLE "Product" (
    ...
    "catogory" "CatogoryEnum" NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
